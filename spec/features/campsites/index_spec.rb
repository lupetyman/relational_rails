...
RSpec.describe 'campsites index page' do
  before :each do
    ...
    @site_18 = @sunset_point.campsites.create!(name: 'Site 18', tent_only: true, overnight_fee: 52)
    @cottonwood_111= @cherry_creek.campsites.create!(name: 'Cottonweood Grove Site 111', tent_only: false, overnight_fee: 28)
    @abilene_10= @cherry_creek.campsites.create!(name: 'Abilene Site 10', tent_only: true, overnight_fee: 41)
    @a_001 = @chatfield.campsites.create!(name: 'A Loop Site 1', tent_only: true, overnight_fee: 41)
